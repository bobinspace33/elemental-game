...
export function SubmitInitialsModal({
  ...
  return (
    ...
    >
      <div className="fixed inset-0 bg-ink-950/88 backdrop-blur-md" aria-hidden />
      <div className="relative z-[1] flex min-h-[100dvh] w-full items-center justify-center px-4 pt-[max(2rem,env(safe-area-inset-top))] pb-[max(2rem,env(safe-area-inset-bottom))]">
