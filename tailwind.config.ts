  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        hitStopPunchT2: {
          "0%": { transform: "scale(1)", filter: "brightness(1)" },
          "38%": { transform: "scale(0.976)", filter: "brightness(1.1)" },
          "100%": { transform: "scale(1)", filter: "brightness(1)" },
        },
        hitStopPunchT3: {
          "0%": { transform: "scale(1) translateX(0)", filter: "brightness(1)" },
          "28%": { transform: "scale(0.968) translateX(-4px)", filter: "brightness(1.12)" },
          "52%": { transform: "scale(0.972) translateX(4px)", filter: "brightness(1.11)" },
          "100%": { transform: "scale(1) translateX(0)", filter: "brightness(1)" },
        },
        hitStopPunchT4: {
          "0%": { transform: "scale(1) translateX(0)", filter: "brightness(1)" },
          "22%": { transform: "scale(0.958) translateX(-6px)", filter: "brightness(1.16)" },
          "44%": { transform: "scale(0.964) translateX(6px)", filter: "brightness(1.14)" },
          "66%": { transform: "scale(0.97) translateX(-3px)", filter: "brightness(1.1)" },
          "100%": { transform: "scale(1) translateX(0)", filter: "brightness(1)" },
        },
        correctSlotPop: {
          "0%": { transform: "scale(1)" },
      ...
      animation: {
        ...
        hitStopT2: "hitStopPunchT2 118ms cubic-bezier(0.34, 1.25, 0.64, 1) both",
        hitStopT3: "hitStopPunchT3 148ms cubic-bezier(0.32, 1.3, 0.62, 1) both",
        hitStopT4: "hitStopPunchT4 182ms cubic-bezier(0.3, 1.35, 0.6, 1) both",
